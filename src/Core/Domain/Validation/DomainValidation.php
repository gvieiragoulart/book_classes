...
class DomainValidation
{
    ...
    public static function dateCantLessThan(DateTime $value, DateTime $date, string $expectMessage = null)
    {
        if ($value < $date) {
            throw new EntityValidationException($expectMessage ?? "Should not less than {$date}");
        }
    }
}
